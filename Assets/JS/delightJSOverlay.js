...
function performSearch(searchQuery) {
    ...
    const data = [
        // Traditional
        { click: 'onclick="showProductOverlay(\'Matcha\')"', name: 'Matcha', price: '250g - 10.99$', image: '/Assets/Pics/TranditionalTea/Matche edited.png' },
        { click: 'onclick="showProductOverlay(\'Hojicha\')"', name: 'Hojicha', price: '250g - 10.99$', image: '/Assets/Pics/TranditionalTea/Hojicha edited.png' },
        { click: 'onclick="showProductOverlay(\'Sencha\')"', name: 'Sencha', price: '250g - 10.99$', image: '/Assets/Pics/TranditionalTea/Sencha edited.png' },
        { click: 'onclick="showProductOverlay(\'Konacha\')"', name: 'Konacha', price: '250g - 10.99$', image: '/Assets/Pics/TranditionalTea/Konacha edited.png' },
        { click: 'onclick="showProductOverlay(\'Genmaicha\')"', name: 'Genmaicha', price: '250g - 10.99$', image: '/Assets/Pics/TranditionalTea/Genmaicha edited.png' },
        { click: 'onclick="showProductOverlay(\'Kunicha\')"', name: 'Kunicha', price: '250g - 10.99$', image: '/Assets/Pics/TranditionalTea/Kuchicha edited.png' },
        { click: 'onclick="showProductOverlay(\'Tamaruokucha\')"', name: 'Tamaruokucha', price: '250g - 10.99$', image: '/Assets/Pics/TranditionalTea/Tamaruokucha edited.png' },
